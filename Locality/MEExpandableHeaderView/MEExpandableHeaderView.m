...
@property(nonatomic, strong) NSArray *imagesURLArray; // изменил
@property(nonatomic, strong) NSArray *imagesArray; // изменил
      ...
      contentPages:(NSArray*)pages
{
    ...
    if (self)
    {
        ...
        _originalImage = [self.imagesArray firstObject];
        
        self.imagesURLArray = imagesURL;
...
- (void)scrollViewDidEndScrolling:(UIScrollView *)scrollView
{
    if (scrollView == self.pagesScrollView)
    {
        ...
        // Изменил
        self.backgroundImageView.image = [self.imagesArray objectAtIndex:self.pageControl.currentPage];
    }
}
