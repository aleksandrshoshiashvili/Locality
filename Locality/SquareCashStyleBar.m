...
- (id)initWithFrame:(CGRect)frame
    ...
    if (self) {
        [self configureBarWithPlaceName:placeName features:featuresImagesArray workhour:workhourText];
    }
    return self;
...
- (void)configureBarWithPlaceName:(NSString *)placeName features:(NSArray *)feauresImagesArray workhour:(NSString *)workhourText {
    // Configure bar appearence
    self.maximumBarHeight = 200.0;
    self.minimumBarHeight = 65.0;
