...
//    FilterCollectionViewCell *cell = (FilterCollectionViewCell *)[self.collectionView cellForItemAtIndexPath:indexPath];
//    [cell.buttonFilter setTintColor:selectFilterColor];
//  }
  
  for (FilterCollectionViewCell *cell in self.collectionView.visibleCells) {
    [cell.buttonFilter setTintColor:selectFilterColor];
  }
...
//    NSIndexPath *indexPath = [NSIndexPath indexPathWithIndex:i];
//    FilterCollectionViewCell *cell = (FilterCollectionViewCell *)[self.collectionView cellForItemAtIndexPath:indexPath];
//    [cell.buttonFilter setTintColor:[UIColor whiteColor]];
//  }
...
- (IBAction)actionDeliver:(id)sender {
}

- (IBAction)actionTakeAway:(id)sender {
}
